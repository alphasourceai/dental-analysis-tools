...
class ConsultingAgreement(Base):
    ...
    ba_signer_token_hash = Column(Text, nullable=True, unique=True, index=True)
    ba_signer_token_expires_at = Column(DateTime(timezone=True), nullable=True)
    sent_at = Column(DateTime(timezone=True), nullable=True)
    opened_at = Column(DateTime(timezone=True), nullable=True)
    ba_opened_at = Column(DateTime(timezone=True), nullable=True)
    ...
    client_signature_image_path = Column(Text, nullable=True)
    client_signature_sha256 = Column(Text, nullable=True)
    ...
    ba_signer_authority_confirmed = Column(Boolean, nullable=False, server_default=text("false"))
    ba_signer_accepted = Column(Boolean, nullable=False, server_default=text("false"))
    ba_signed_at = Column(DateTime(timezone=True), nullable=True)
    ba_signer_ip = Column(Text, nullable=True)
    ba_signer_user_agent = Column(Text, nullable=True)
...
class PublicLeadDraft(Base):
    ...
    source_referrer_host = Column(Text, nullable=True)
